...
import { FileExistsException } from '../exception/FileExistsException';
...
export class FluentConverter{
    ...
    public async convertMetadataFileToFluent(metadataFileName:string, saveGenerated:boolean=true) : Promise<any> {
