import { HttpResponse, IHttpResponse } from "../comm";
...
export class ProjectRequest{
    ...
    public async getSysMetadataObjectsForApplication(appSysId:string, classNames:string[], addtFields:string = "") : Promise<IHttpResponse<SysMetadata>>{
       ...
       let resp:IHttpResponse<SysMetadata> =  await request.get<SysMetadata>("sys_metadata", params);
        return resp;
    }
}