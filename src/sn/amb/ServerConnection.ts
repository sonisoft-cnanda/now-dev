...
export class ServerConnection {
	 ...
	 * @param url Instance URL (e.g., https://instance.service-now.com)
	 */
	...
	public getBaseUrl():string{
		// Use dynamic instance URL if set, otherwise fall back to hard-coded for backwards compatibility
		return this._instanceUrl || "https://tanengdev012.service-now.com";
	}

	public getUserToken(){
		// Use dynamic user token if set, otherwise fall back to hard-coded for backwards compatibility
		return this._userToken || "49c21d3c0f2c3a10ab240ff800d1b2d29dd1b33d87a05b1aa4c0f3a52b0efd8e04ca4628";
	}
